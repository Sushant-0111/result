...
<html>
    ...
    <body>
        <nav style="background:#404040; margin-top:-23px; " class="home nav nav-pills flex-column flex-sm-row">
        ...
        <div class="row mb-4">
            <label for="input-text" style="color:black; font-weight:bold; font-size:20px;" class="col-sm-5 col-form-label">Enter the Course name </label>
            <div class="col-sm-5">
            <input type="text" name="name" name="course" class="form-control" id="inputEmail3">
            </div>
        </div>
