...
<html>
    ...
    <nav style="background:#404040;  " class="home nav nav-pills flex-column flex-sm-row">
        ...
        <div class="row mb-3">
            <label for="input-text" style="color:black; font-weight:bold; font-size:20px;" class="col-sm-6 col-form-label">Enter the subject name </label>
            <div class="col-sm-6">
            <input type="text" name="subjectname" class="form-control" id="inputEmail3">
            </div>
        </div>
